...
Board.prototype.getDiagonalWinner = function () {
...
Board.prototype.getHorizontalWinner = function () {
...
Board.prototype.getVerticalWinner = function () {
  for (let idx = 0; idx < 3; idx++) {
    if (
...
Board.prototype.setMove = function (moveNumber, token) {
