...
let HumanPlayer = Object.create(PlayerPrototype);

HumanPlayer.makeMove = function (board) {
  console.clear();
...
let ComputerPlayer = Object.create(PlayerPrototype);
ComputerPlayer.makeMove = function (board) {
  const availableMoves = board.getAvailableMoves();
...
let Game = {
  ...
  init() {
    this.human = Object.create(HumanPlayer).init(Game.HUMAN_MARKER);
    this.computer = Object.create(ComputerPlayer).init(Game.COMPUTER_MARKER);
